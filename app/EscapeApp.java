...
/**
 * Klasse EscapeApp ist die Hauptklasse des Escape-Spiels.Sie verwaltet das
 * Hauptmenü und die Spielzustände.
 * Sie ermöglicht das starten eines Spiels, das laden, fortsetzen, speichern,
 * löschen und beeenden.
 * 
...
public class EscapeApp {
     ...
     * Die Methode gibt alle verfügbaren Optionen an, wobei bestimmte Optionen nur
     * dann eingeblendet werden, wenn die entsprechenden Bedingungen erfüllt sind.
     */
        ...
        switch (input) {
            ...
            case "4":
                if (isGameRunning() && !isGameFinished()) {
                    ...
                    System.out.println(
                            "Es läuft kein Spiel oder das Spiel ist bereits beendet. Bitte starte ein neues Spiel.");
