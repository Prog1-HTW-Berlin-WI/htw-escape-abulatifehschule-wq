 ...
 * @param longRest true wenn große Pause eingelegt werden soll und false bei kleiner
 */
 ...
 * Fehlschläge mit keinem Schaden passieren zu 13% und starke Treffer mit einer Wahrscheinlichkeit von 12%.
...
public void signExerciseLeader(Lecturer lecturer){
    ...
    for (int i = 0; i < this.signedExerciseLeaders.length; i++){
        if (this.signedExerciseLeaders[i] == null){
            ...
            System.out.println("Sie heben eine Unterschrift von " + lecturer.getName() + " erhalten!");
            return;
        }
    }
}
